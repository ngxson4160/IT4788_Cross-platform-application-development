import 'package:facebook/tabs/list_friend.dart';
...
class ProfileTab extends StatefulWidget {
  ...
  String? id;
  String? avatar;
  ProfileTab({this.name, this.id, this.avatar});

  @override
  State<ProfileTab> createState() =>
      ProfileTabState(name: this.name, avatar: this.avatar, id: this.id);
}
...
class ProfileTabState extends State<ProfileTab> {
  ...
  String? id;
  String? avatar;
  ProfileTabState({this.name, this.id, this.avatar});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: (id != ApiValues.ID)
          ? AppBar(
              ...
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      backgroundImage:
                          // NetworkImage(ApiValues.AVATAR.toString()),
                ...
                GestureDetector(
                  onTap: (() {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ListFriends(id: id)));
                  }),
                  child: Container(
