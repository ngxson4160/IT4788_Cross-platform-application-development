...
class _UploadImagesState extends State<UploadImages> {
  ...
  Future<void> _uploadImage(File image, String token) async {
    String url =
        'https://flutter-hust.onrender.com/it4788/post/add_post?token=${token}';
          ...
          TextButton(
            onPressed: () {
              for (var image in _images) {
                _uploadImage(image, ApiValues.TOKEN.toString());
              }
            },
